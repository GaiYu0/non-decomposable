...
parser.add_argument('--decay-at', type=int, default=None)
parser.add_argument('--gpu', type=int, default=None)
parser.add_argument('--iw', type=str, default='none')
parser.add_argument('--log-every', type=int, default=100)
parser.add_argument('--n-iterations', type=int, default=25000)
parser.add_argument('--n-iterations-critic', type=int, default=15)
...
#             mse = th.sum(w * delta * (th.sign(delta) - th.sign(t)))
    ...
    if i + 1 == args.decay_at:
        for pg in c_optim.param_groups:
            pg['lr'] *= 0.1
